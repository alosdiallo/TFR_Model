...
#Here I include code to generate the importance plot
library(dplyr)
...
```{r}
library(readxl)
TfhTfr_Exon_AllGenes_combined <- read_excel("F:/Research/Sage/TfhTfr_Exon_AllGenes_combined.xlsx")
...
Ymatrix = unlist(TfhTfr_Exon_AllGenes_combined_Yes[1:5151 ,2:89])
Ymatrix = as.numeric(Ymatrix)
Ymatrix = matrix(Ymatrix,nrow = 5151,ncol = 88)
...
YNHeatmap_matrix = matrix(YNHeatmap_matrix,nrow = 98,ncol = 85)
