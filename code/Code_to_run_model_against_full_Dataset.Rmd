...
p = pheatmap(Copy_subsetYes,cutree_rows = 2,cutree_cols = 2,scale = 'row')
p
...
p
ggsave(file="subListYesGenes_cell_types.svg", plot=p, width=10, height=8)
...
heatmap(holder,col= bluered(100))

p = pheatmap(holder,cutree_rows = 2,cutree_cols = 2,scale = 'row')
p
ggsave(file="test.svg", plot=p, width=10, height=8)
```
